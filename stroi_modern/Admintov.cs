...
{
    public partial class Admintov : Form
    {
        ...
        private void remaster_ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            obnovtov form = new obnovtov(selectedProduct.Id,selectedProduct.Name,selectedProduct.Article,selectedProduct.Price,selectedProduct.Type_id);
            this.Hide();
            form.Show();
        }
